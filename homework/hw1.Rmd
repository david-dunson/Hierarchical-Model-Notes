...
\end{eqnarray}
  ...
  b. Show that the estimates of these mean differences are identical regardless of the coding scheme used, either theoretically or by analyzing the Game of Thrones data using a one-way ANOVA model with gender as the only predictor.
  
  
### 4. (Required for 601, extra credit for 401.) Prove or disprove. Suppose $X$ and $Y$ each follow *univariate* normal distributions and that $\text{Cov}(X,Y)=0$. Then $X$ is independent of $Y$.
