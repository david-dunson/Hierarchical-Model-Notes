...
Two in-class examinations will be given as specified on the syllabus. If you know in advance you must miss an in-class examination, please contact Prof. Herring as soon as possible. 

#### Make-up Examinations and Substitute Credit

During the last week of undergraduate classes, students will have the opportunity to earn credit towards a limited number of missed assignments (or assignments with grades a student would like to improve).  The optional in-class assignment on Wednesday, December 4 may be used to replace *either* one in-class examination grade *or* one homework grade.  The optional in-class assignment on Friday, December 6 may be used to replace *either* one group case study grade *or* one homework grade. 

These assignments will be challenging and designed to evaluate mastery of the material. If the make-up grade is lower than the grade to be replaced, it will not be used (that is, completing these assignments will not lower a student's grade).
