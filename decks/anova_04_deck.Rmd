...
## Challenge to Validity: Heterogeneous Variances

One potential challenge is that the variance of income across hospitals may not be the same for each state. This could be due to a variety of factors. One potential remedy for this issue is to allow the error variance to differ across groups, with 
