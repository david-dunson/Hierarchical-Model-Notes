...
Prerequisites for this course include STA 360 (Bayesian Inference) and all its prerequisite at Duke (linear algebra, multivariable calculus, probability, inference, and regression).
