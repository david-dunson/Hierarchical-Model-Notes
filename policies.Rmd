...
Reports from lab will be turned in (group work) and graded after most labs.
...
During the last week of undergraduate classes, students will have the opportunity to earn credit for one missed assignment (or one assignment a grade a student would like to improve).  The optional in-class assignment on Monday, December 2 may be used to replace one in-class examination grade *or* one homework grade *or* one case study grade (if you miss two things, you're going to have a 0 somewhere, so please avoid that).
