...
ML estimation is carried out typically using adaptive Gaussian quadrature. To improve accuracy over many package defaults (Laplace approximation), increase the number of quadrature points to be greater than one. Noe that some software require Laplace approximation with Gaussian quadrature if the number of random effects is more than 1 for the sake of computational efficiency.
